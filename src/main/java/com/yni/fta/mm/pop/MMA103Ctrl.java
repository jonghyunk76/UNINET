 ...
 */
@Controller
public class MMA103Ctrl extends YniAbstractController {

    @Resource(name = "mmA103")
    private MMA103 mmA103;
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/mm/pop/mmA103_01")
    public ModelAndView mmA103_01Move(DataMap dataMap) throws Exception {
        return WebAction.forwarding("/POP/MM-A103_01", dataMap);
    }
     ...
     * @exception Exception
     */
    @RequestMapping("/mm/pop/mmA103_01/selectCOIssueInfo")
    public ModelAndView selectCOIssueInfo(HttpServletRequest req, DataMap dataMap) throws Exception {
        Map result = null;
        String message = null;

        try {
            result = mmA103.selectCOIssueInfo(DataMapHelper.getMap(dataMap));
        } catch (Exception e) {
     ...
     * @exception Exception
     */
    @RequestMapping("/mm/pop/mmA103_01/selectExportNProducerInfo")
    public ModelAndView selectExportNProducerInfo(HttpServletRequest req, DataMap dataMap) throws Exception {
        Map result = null;
        String message = null;

        try {
            result = mmA103.selectExportNProducerInfo(DataMapHelper.getMap(dataMap));
        } catch (Exception e) {
            message = getExceptionMessage(req, e, this.getMessage("TXT_SYSTEM_ERROR", null, StringHelper.null2string(dataMap.get("SESSION_DEFAULT_LANGUAGE"), Constants.DEFAULT_LANGUAGE)));
        }
     ...
     * @exception Exception
     */
    @RequestMapping("/mm/pop/mmA103_01/selectCOOriginList")
    public ModelAndView selectCOOriginList(HttpServletRequest req, DataMap dataMap) throws Exception {
        List resultList = null;
        String message = null;

        try {
            resultList = mmA103.selectCOOriginList(DataMapHelper.getMap(dataMap));
        } catch (Exception e) {
            message = getExceptionMessage(req, e, this.getMessage("TXT_SYSTEM_ERROR", null, StringHelper.null2string(dataMap.get("SESSION_DEFAULT_LANGUAGE"), Constants.DEFAULT_LANGUAGE)));
        }
     ...
     * @exception Exception
     */
    @RequestMapping("/mm/pop/mmA103_01/selectDeterminateList")
    public ModelAndView selectDeterminateList(HttpServletRequest req, DataMap dataMap) throws Exception {
        List resultList = null;
        String message = null;

        try {
            resultList = mmA103.selectDeterminateList(DataMapHelper.getMap(dataMap));
        } catch (Exception e) {
            message = getExceptionMessage(req, e, this.getMessage("TXT_SYSTEM_ERROR", null, StringHelper.null2string(dataMap.get("SESSION_DEFAULT_LANGUAGE"), Constants.DEFAULT_LANGUAGE)));
        }
     ...
     * @exception Exception
     */
    @RequestMapping("/mm/pop/mmA103_01/selectSignatureInfo")
    public ModelAndView selectSignatureInfo(HttpServletRequest req, DataMap dataMap) throws Exception {
        ...
        try {
            ...
            result = mmA103.selectSignatureInfo(map);
     ...
     */
    @ResponseBody
    @RequestMapping("/mm/pop/mmA103_01/selectSignatureFile/{signatureSeq}")
    public byte[] selectSignatureFile(@PathVariable("signatureSeq") String signatureSeq, HttpServletRequest req, DataMap dataMap) throws Exception {
        ...
        try {
            ...
            Map result = mmA103.selectSignatureInfo(map);
     ...
     * @exception Exception
     */
    @RequestMapping("/mm/pop/mmA103_02/selectInvoiceInfo")
    public ModelAndView selectInvoiceInfo(HttpServletRequest req, DataMap dataMap) throws Exception {
        Map result = null;
        String message = null;

        try {
            result = mmA103.selectInvoiceInfo(DataMapHelper.getMap(dataMap));
        } catch (Exception e) {
            message = getExceptionMessage(req, e, this.getMessage("TXT_SYSTEM_ERROR", null, StringHelper.null2string(dataMap.get("SESSION_DEFAULT_LANGUAGE"), Constants.DEFAULT_LANGUAGE)));
        }
     ...
     * @exception Exception
     */
    @RequestMapping("/mm/pop/mmA103_02/updateInvoiceInfo")
    public ModelAndView updateInvoiceInfo(HttpServletRequest req, DataMap dataMap) throws Exception {
        boolean success = true;
        String message = null;

        try {
            int resultCnt = mmA103.updateInvoiceInfo(DataMapHelper.getMap(dataMap));
     ...
     * @exception Exception
     */
    @RequestMapping("/mm/pop/mmA103_01/selectCoDocList")
    public ModelAndView selectCoDocList(HttpServletRequest req, DataMap dataMap) throws Exception {
        List resultList = null;
        String message = null;

        try {
            resultList = mmA103.selectCoDocList(DataMapHelper.getMap(dataMap));
        } catch (Exception e) {
            message = getExceptionMessage(req, e, this.getMessage("TXT_SYSTEM_ERROR", null, StringHelper.null2string(dataMap.get("SESSION_DEFAULT_LANGUAGE"), Constants.DEFAULT_LANGUAGE)));
        }
    ...
    @RequestMapping("/mm/pop/mmA103_01/executeIssueCoDoc")
