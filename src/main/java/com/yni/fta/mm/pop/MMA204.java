...
public interface MMA204 {
     ...
     * @throws Exception
     */
    List executeDeterminateList(Map map) throws Exception;
     ...
     * @throws Exception
     */
    List executeProducerList(Map map) throws Exception;
     ...
     * @throws Exception
     */
    List selectCOProducerList(Map map) throws Exception;
