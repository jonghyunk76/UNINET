...
public class MLDeliveryStatusInquiryService_InboundPortBindingStub extends org.apache.axis.client.Stub implements samsung.esb.mail.service.MLDeliveryStatusInquiryService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getRecipientStatusByList");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "esbAuthVO"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://samsung/esb/common/vo", "ESBAuthVO"), samsung.esb.common.vo.ESBAuthVO.class, false, false);
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "recipientMtrKey"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "recipientResourceWSVO"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://samsung/esb/mail/vo", "ResourceCSVO"), samsung.esb.mail.vo.ResourceCSVO.class, false, false);
        param.setNillable(true);
        oper.addParameter(param);
        ...
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://samsung/esb/mail/service", "getRecipientStatusByListFault1_esbFaultVO"),
                      "samsung.esb.common.vo.ESBFaultVO",
                      new javax.xml.namespace.QName("http://samsung/esb/common/vo", "ESBFaultVO"), 
                      true
                     ));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {esbAuthVO, mtrKey, resourceCSVO});
  ...
  throw axisFaultException;
    ...
    public samsung.esb.mail.vo.RecipientESBVO[] getRecipientStatusByList(samsung.esb.common.vo.ESBAuthVO esbAuthVO, java.lang.String recipientMtrKey, samsung.esb.mail.vo.ResourceCSVO recipientResourceWSVO, int currentPage, int pageSize) throws java.rmi.RemoteException, samsung.esb.common.vo.ESBFaultVO {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://samsung/esb/mail/service", "getRecipientStatusByList"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {esbAuthVO, recipientMtrKey, recipientResourceWSVO, new java.lang.Integer(currentPage), new java.lang.Integer(pageSize)});
