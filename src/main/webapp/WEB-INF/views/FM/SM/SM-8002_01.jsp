...
<%
  ...
  * 
  * <notice>
  * 본 화면을 다리얼로그로 사용할 경우 명칭을 "SM8002_01_dialog_01"으로 하셔야 합니다.
  */
%>
<!DOCTYPE html>
<html>
    ...
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'north',border:false" class="sch_box2">
            <div class="sch_boxIn2">
                <form id="SM8002_01_form_01" name="SM8002_01_form_01" method="POST">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" id="schKeyWord" name="schKeyWord" search="SM8002_01.control.selectQnAList" style="width:130px;paddig:0;"/>
                                    <input type="text" id="schKeyLike" name="schKeyLike" style="width:80px;"/>
                                </td>
                                <td class="txt_R">
                                    <a href="javascript:SM8002_01.control.selectQnAList();" class="easyui-linkbutton pop_sch" id="SM8002_01_searchBtn">
        ...
        <div data-options="region:'center',border:false" style="height:100%;padding-top:6px;">
            <div class="easyui-layout" data-options="fit:true">
                <div data-options="region:'north',border:false" class="h2_etc">
                    <p id="SM8002_01_span_01" class="h2"></p>
                    <p class="h2_btn">
                        <a href="javascript:SM8002_01.dialog.openDialog_1('insert');" class="btnNewRegiste"><spring:message code="REGER"/></a>
                        <a href="javascript:SM8002_01.dialog.openDialog_1('update');" class="btnEdit"><spring:message code="MOD"/></a>
                    </p>
                </div>
                <div data-options="region:'center',border:false">
                   <table id="SM8002_01_grid_01"> </table>
                </div>
            </div>
        </div>
    </div>
    
    <script type="text/javascript" src="/js/views/FM/SM/SM-8002_01.js"></script>
