...
<%
  ...
  * 
  * <notice>
  * 본 화면을 다리얼로그로 사용할 경우 명칭을 "SM8002_02_dialog_01"으로 하셔야 합니다.
  */
%>
<!DOCTYPE html>
<html>
...
<body>
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center',border:false" style="overflow:hidden;">
            <div class="btn_R">
                <a href="javascript:SM8002_02.control.insertReplyInfo('reply');" id="SM8002_02_btn_01" class="btnSave" style="display:none;"><%--답변--%><spring:message code="REPLY"/></a>
                <a href="javascript:SM8002_02.control.updateQnAInfo();" id="SM8002_02_btn_02" class="btnSave"><%--저장--%><spring:message code="SAVE"/></a>
                <a href="javascript:SM8002_02.control.deleteQnAInfo();" id="SM8002_02_btn_03" class="btnDelete" style="display:none;"><spring:message code="DEL"/></a>
                <a href="javascript:dialog.handle.close(dialog.getObject('SM8002_02_dialog_01'));" class="btnPopClose"><spring:message code="CLOSE"/></a>
            </div>
            <form id="SM8002_02_form_01" name="SM8002_02_form_01" enctype="multipart/form-data" method="POST">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="height:24px">
                                <div id="SM8002_02_files_div" class="file_box">
                                    <span id="SM8002_02_files_1" class="file_list" onclick="SM8002_02.tooltip.showTooltip();" style="width:23px;"></span>
                                    ...
                                    <span class="file_wrap">
                                        <input type="file" id="FILEUP" name="FILEUP" class="file_add" onchange="javascript:SM8002_02.tooltip.setFiles(this);" multiple/>
                                    </span>
                                </div>
                            </td>
                        </tr>
                        <tr height="90px">
                            <td colspan="5">
                                <table id="SM8002_02_grid_01"></table>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div style="display:none;">
            <form id="SM8002_02_form_02"  method="POST">
                <input type="hidden" id="COMPANY_CD" name="COMPANY_CD" value="${COMPANY_CD}"/>
                <input type="hidden" id="BOARD_ID" name="BOARD_ID" value="${BOARD_ID}"/>
            </form>
        </div>
    ...
    <script type="text/javascript" src="/js/views/FM/SM/SM-8002_02.js"></script>
