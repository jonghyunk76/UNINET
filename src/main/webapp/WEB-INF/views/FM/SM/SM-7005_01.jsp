...
<%
 /**
  * @Class Name : SM-7005_01.jsp
  * @Description : 인터페이스 항목 리스트 조회
  * @Modification Information
  *
  * author carlos
  * 
  * <notice>
  * 본 화면을 다리얼로그로 사용할 경우 명칭을 "SM7005_01_dailog_01"으로 하셔야 합니다.
  */
%>
<!DOCTYPE html>
<html>
...
<body>
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'north',border:false" class="sch_box2">
            <div class="sch_boxIn2">
                <form id="SM7005_01_form_01" name="SM7005_01_form_01" method="post">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" id="schKeyWord" name="schKeyWord" class="easyui-validatebox" search="SM7005_01.control.selectInterfaceItemMstList" style="width:150px;"/>
                                    <input type="text" id="schKeyLike" name="schKeyLike" style="width:90px;"/>
                                </td>
                                <td class="txt_R">
                                   <a href="javascript:SM7005_01.control.selectInterfaceItemMstList();" 
                                      class="easyui-linkbutton pop_sch" id="SM7005_01_searchBtn"><spring:message code="SRCH"/><%--조회--%></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div data-options="region:'center',border:false" style="padding-top:12px;">
            ...
            <div class="easyui-layout" data-options="fit:true" class="sec_area">
                ...
                <div data-options="region:'north',border:false" class="sec_tit">
    	            <div class="h2_etc">
                       <p class="h2"><spring:message code="SM7005_01"/><%--인터페이스 목록--%></p>
                       <p class="h2_btn">
                           ...
                           <a href="javascript:SM7005_01.dialog.openDialog('update');" class="btnEdit"><spring:message code="MOD"/><%--수정--%></a>
                           <a href="javascript:SM7005_01.excel.excelDownload_1();" class="btnExlDown"><spring:message code="EXCEL, DOWN"/><%--엑셀다운로드--%></a>
                       </p>
                   </div>
    	        </div>
                <!-- //sec_tit -->
    			<div data-options="region:'center',border:false" style="padding-top:0px;">
    			    <table id="SM7005_01_grid_01"></table>
    			</div>
    		</div>
            <!-- //sec_area -->
    	</div>
    ...
    <script type="text/javascript" src="/js/views/FM/SM/SM-7005_01.js"></script>
