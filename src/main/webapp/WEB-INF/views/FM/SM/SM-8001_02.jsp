		                   ...
		                   <form id="SM8001_02_form_02" name="SM8001_02_form_02" method="post">
		                        ...
		                        <table class="gridT" style="margin-bottom:0px">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <textarea id="REQUEST_PARAM" name="REQUEST_PARAM" style="width:99.5%;height:300px">{"Interface_id": "IF-WS-ACTIVITY-VIEW-001","iRecordSeq": "a1S0p000000MjIdEAK","queryDebug":"false"}</textarea>
                                        </td>
                                    </tr>
		                        </table>
		                   </form>
