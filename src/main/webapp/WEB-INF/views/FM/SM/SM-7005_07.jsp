...
<%
  ...
  * 
  * <notice>
  * 본 화면을 다리얼로그로 사용할 경우 명칭을 "SM7005_07_dailog_01"으로 하셔야 합니다.
  */
%>
<!DOCTYPE html>
<html>
...
<body class="h2_etc">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center',border:false">
            <div id="SM7005_07_div_01" class="btn_R">
                <a href="javascript:SM7005_07.control.updateInterfaceItemMstInfo();" id="SM7005_07_btn_01" class="btnSave"><spring:message code="SAVE"/></a>
                <a href="javascript:SM7005_07.control.deleteInterfaceItemMstInfo();" id="SM7005_07_btn_02" class="btnDelete"><spring:message code="DEL"/></a>
            </div>
            <form id="SM7005_07_form_01" name="SM7005_07_form_01" method="post">
                ...
                <input type="hidden" id="ITEM_TYPE" name="ITEM_TYPE" value="J"/><%--T:TABLE, P:PROCEDURE, J:java class--%>
                ...
                <table class="dataT" style="margin-bottom:0px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">
                                <spring:message code="PROGM_NAME"/>(Class)<%--프로그램명--%>
                            </th>
                            <td>
    ...
    <script type="text/javascript" src="/js/views/FM/SM/SM-7005_07.js"></script>
