	            ...
	            <ul>
                    <li>
	                    <div class="login_info">
	                        <div id="MM0000_01_div_03" style="display:none;">
	                            <div style="padding:10px 70px 10px 70px;border:1px solid #c3c3c3;">
		                            <form id="MM0000_01_form_01" name="MM0000_01_form_01" method="post" target="_top">
		                                <input type="hidden" id="CERTIFY_TYPE" name="CERTIFY_TYPE" value="${CERTIFY_TYPE}"/>
		                                ...
		                                <table>
	                                        ...
	                                        <tbody>
	                                            <tr style="height:40px;">
	                                                <th><span id="MM0000_01_div_02"><label id="company"><spring:message code="CONPY"/></label></span></th>
	                                                <td>
				                        ...
				                        <tbody>
				                            ...
				                            <tr style="height:55px;">
				                                <td style="text-align:center;">
				                                    <input type="text" name="BUSINESS_NO" id="BUSINESS_NO" class="input_login" style="width:400px;border:1px solid #c3c3c3;"/>
				                                </td>
				                            </tr>
                                            <tr>
				                                <td style="text-align:center;">
	                        ...
	                        <!-- 통관 시스템 회사 확인 -->
	                        <div id="MM0000_01_div_09" style="display:none;padding:30px 0px 0px 15px;">
                                <form id="MM0000_01_form_04" name="MM0000_01_form_04" method="post">
                                    <input type="hidden" id="REQ_TYPE" name="REQ_TYPE" value="EXISTS"/>
                                    <input type="hidden" id="COMPANY_CD" name="COMPANY_CD"/>
                                    <input style="display:none;width:0px;">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr style="height:55px;">
                                                <td style="text-align:center;">
                                                    <input type="text" name="BUSINESS_NO" id="BUSINESS_NO" search="MM0000_01.control.selectFTAMgmtSysCompany" class="input_login" style="width:400px;border:1px solid #c3c3c3;"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align:center;">
                                                   <a href="javascript:MM0000_01.control.selectFTAMgmtSysCompany();" class="btnLoginBlue"><spring:message code="CC_통관 관리 시스템"/></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
