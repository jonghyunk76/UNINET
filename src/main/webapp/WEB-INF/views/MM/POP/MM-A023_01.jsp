...
<%
  ...
  * 
  * <notice>
  * 본 화면을 다리얼로그로 사용할 경우 명칭을 "MMA023_01_dailog_01"으로 하셔야 합니다.
  *
  */
%>
<!DOCTYPE html>
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north',border:false" class="sch_box2">
	        <div class="sch_boxIn2">
                <form id="MMA023_01_form_01" enctype="multipart/form-data" method="POST">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding-left:10px;">
                                    <p class="h2_btn">
	                                   <a href="javascript:MMA023_01.control.saveExcelSample();" class="btnFileImport" id="MMA023_01_btn_01"><spring:message code="BTN_EXCEL_UPLOAD"/><%--조회--%></a>
	                                </p>
	                            </td>
                            </tr>
                        </tbody>
            ...
            <div class="easyui-layout" data-options="fit:true">
                <div data-options="region:'north',border:false" class="h2_etc">
                    ...
                    <p class="h2_btn" style="padding:0 10px 0 0;">
                        <a href="javascript:MMA023_01.control.saveItemList();" id="MMA023_01_btn_02" class="btnMainSave"><spring:message code="APYDT"/></a>
                    </p>
                </div>
                <div data-options="region:'center',border:false">
                   <table id="MMA023_01_grid_01"> </table>
                </div>
            </div>
        </div>
    </div>
    
    <script type="text/javascript" src="/js/views/MM/POP/MM-A023_01.js"></script>
