...
<%
 /**
  * @Class Name : MM-A020_01.jsp
  * @Description : 멕시코 외부원산지품목 정보
  * @Modification Information
  *
  * author carlos
  * 
  * <notice>
  * 본 화면을 다리얼로그로 사용할 경우 명칭을 "MMA020_01_dailog_01"으로 하셔야 합니다.
  */
%>
<!DOCTYPE html>
<html>
...
<body class="h2_etc">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center',border:false" style="overflow:hidden;">
	        <div id="MMA020_01_div_01" class="btn_R">
	            <a href="javascript:MMA020_01.control.saveDetailInfo();" id="MMA020_01_btn_01" class="btnSave"><spring:message code="APYDT"/><%--적용--%></a>
	        </div>
	        <form id="MMA020_01_form_01" name="MMA020_01_form_01" method="POST">
	                ...
	                <tbody>
	                    <tr>
	                        ...
	                        <td colspan="3">
							    ...
							    <span id="MMA020_01_form_01_ITEM"><a href="javascript:MMA020_01.dialog.openDialog1();"><img src="/images/sample/btn_sch.gif" alt="<spring:message code='SRCH'/><%--조회--%>" /></a></span>
	                        </td>
	                    </tr>
	                    <tr>
	                        <th scope="row" class="point2">
	                        ...
	                        <th scope="row" class="point2">
	                            <spring:message code="TXT_FTA_GRP_CD"/><%--FTA그룹코드--%>
	                        </th>
	                        <td>
	                            <input type="text" name="FTA_GROUP_CD" id="FTA_GROUP_CD" value="${FTA_GROUP_CD}" class="easyui-validatebox" size="20"/>
	                        </td>
	                    </tr>
	                    <tr>
	                        <th scope="row" class="point2">
	                        ...
	                        <td>
	                            <input type="text" name="HS_CODE" id="HS_CODE" value="${HS_CODE}" class="easyui-validatebox" required="true" validType="['minlength[8]','number']" size="20" 
	                                onkeyup="javascript:MMA020_01.control.selectRuleContents();" />
	                        </td>
	                        <th scope="row" class="point2">
	                            <spring:message code="TXT_RULE_CODE_NAME"/><%--결정기준--%>
	                        </th>
	                        <td>
	                    ...
	                    <tr>
	                        <c:if test="${FTA_GROUP_CD eq 'ML'}">
	                            ...
	                            <td>
	                                <input type="text" name="NALADISA_CODE" id="NALADISA_CODE" value="${NALADISA_CODE}" class="easyui-validatebox" validType="['maxlength[10]']" size="20" onkeyup="javascript:MMA020_01.control.selectRuleContents('nlds', this.value);"/>
	                            </td>
	                        </c:if>
    ...
    <script type="text/javascript" src="/js/views/MM/POP/MM-A020_01.js"></script>
