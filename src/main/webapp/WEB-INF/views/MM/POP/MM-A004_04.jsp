...
<%
 /**
  * @Class Name : MM-A004_04.jsp
  * @Description : 협력사 사급확인서 발급
  * @Modification Information
  *
  * author 이재욱
  * 
  * <notice>
  * 본 화면을 다리얼로그로 사용할 경우 명칭을 "MMA004_04_dailog_01"으로 하셔야 합니다.
  */
%>
<!DOCTYPE html>
<html>
...
<body>
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'west',border:true" style="width:270px;" id="MMA004_04_out_list">
            <div class="easyui-layout" data-options="fit:true">
                <div data-options="region:'north',border:false" style="padding:1px;">
                    <form id="MMA004_04_form_01" name="MMA004_04_form_01" method="post">
                        ...
                        <input type="hidden" id="DOC_FILE_NAME" name="DOC_FILE_NAME" value="COVER_ver.1.2"/>
                    ...
                    <div class="easyui-layout" data-options="fit:true">
                        <div data-options="region:'north',border:false" style="padding:0 3px 0 3px;">
                            <div class="h2_etc">
                                ...
                                <p class="h2_btn">
                                    <a href="javascript:MMA004_04.control.executeIssueCoDoc();" class="btnFile" style="display:none;"><spring:message code="OUTP"/></a>
                                </p>
                            </div>
                        </div>
                        <div data-options="region:'center',border:false">
                            <table id="MMA004_04_grid_01"></table>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div data-options="region:'center',border:false" style="padding:0 0 0 3px;">
            <div class="easyui-panel" id="MMA004_04_panel_01" data-options="border:false,fit:true"></div>
        </div>
    </div>
    
    <script type="text/javascript" src="/js/views/MM/POP/MM-A004_04.js"></script>
