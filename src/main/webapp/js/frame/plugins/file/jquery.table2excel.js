        ...
        init: function () {
            ...
            e.template = {
                ...
                mid: "</x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]-->" +
                		"<style> table {border-collapse:collapse;border:1px solid #000;} td, th {border:1px solid #c7cbce} </style></head><body>",
                // 테이블 구조는 타 보고서에 따라 다르게 작성해야 함
                table: {
                    head: "<table><colgroup><col style='width:120px;'/><col style='width:240px;'/><col style='width:130px;'/><col style='width:145px;'/></colgroup>",
                    tail: "</table>"
                },
                foot: "</body></html>"
            };
