/******************************************************************************************
 * 작성자 : YNI-Maker
 * Program Id : MM-A001_05
 * 작업일자 : 2016.09.28
 * 
 ******************************************************************************************/

function onLoadPage() {
	MMA001_05.config.applyFtaNation();
    MMA001_05.init.initComponent();
}
...
var MMA001_05 = {
    ...
    datagrid : {
    	...
    	header2_1 : {params : ""},
    	initGrid_1 : function() {
    		var param1 = {PID:"MMA001_05", GRID_ID:"MMA001_05_grid_01"};
            var dg_1 = grid.getObject("MMA001_05_grid_01");
