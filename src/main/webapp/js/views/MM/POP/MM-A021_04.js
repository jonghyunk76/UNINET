/******************************************************************************************
 * 작성자 : YNI-Maker
 * Program Id : MM-A021_04
 * 작업일자 : 2016.09.28
 * 
 ******************************************************************************************/

function onLoadPage() {
	MMA021_04.config.applyFtaNation();
    MMA021_04.init.initComponent();
}
...
var MMA021_04 = {
    ...
    init : {
        initComponent : function() {
        	MMA021_04.combobox.initCombo_1();
        	MMA021_04.combobox.initCombo_2();
        }
    }, 
    // 달력 생성
    calendar : {}, 
    ...
    combobox : {
    	initCombo_1 : function() {
            var obj_1 = combo.getObject("MMA021_04_form_01", "EV_DOC_TYPE"); 
        ...
        initCombo_2 : function() {
        	var params = form.handle.getElementsParam("MMA021_04_form_01");
            var obj_1 = combo.getObject("MMA021_04_form_01", "ITEM_CD"); 
            
            params.MESSAGE_CODE = "SELET";
    ...
    event : {
    	...
    	saveEvDocFile : function() {
    		...
    		MMA021_04.dialog.closeDialog();
    	}
    },
    // 업무구현
    control : {
    	saveEvDocFile : function() {
    		if(!form.handle.isValidate("MMA021_04_form_01")) return;
    		
    		$.messager.confirm(CNFIR, resource.getMessage("MSG_CONFIRM_SAVE"), function(flag) {                
        		if(flag) {
		    		var obj = form.getObject("MMA021_04_form_01");
    ...
    dialog : {
    	closeDialog : function() {
    		var dl_1 = dialog.getObject("MMA021_04_dailog_01");
    ...
    file : {
    	setFiles : function(pfile) {
            ...
            if(tts > parseInt(10000000)) {
                ...
                form.handle.setValue("MMA021_04_form_01", "PRF_FILE", "");
                return;
            }
    	}
    }, 
    ...
    config : {
    	applyFtaNation : function() {
    		var vcd = form.handle.getValue("MMA021_04_form_01", "VENDOR_CD");
            var in_vcd = form.handle.getValue("MMA021_04_form_01", "IN_VENDOR_CD");
            
            if(oUtil.isNull(vcd)) {
                form.handle.setValue("MMA021_04_form_01", "VENDOR_CD", in_vcd);
            }
    	}
    }
};
