/******************************************************************************************
 * 작성자 : 유동기
 * Program Id : SM-8002_01
 * 작업일자 : 2017.07.12
 * 
 ******************************************************************************************/

function onLoadPage() {
    SM8002_01.config.applyFtaNation();
    SM8002_01.init.initComponent();
}
...
var SM8002_01 = {
    ...
    init : {
        initComponent : function() {
            SM8002_01.combobox.initCombo_1();
            SM8002_01.combobox.initCombo_2();
            
            SM8002_01.datagrid.initGrid_1();
    ...
    combobox : {
        ...
        initCombo_1 : function() {
            var objSearchType = combo.getObject("SM8002_01_form_01", "schKeyField");
        ...
        initCombo_2 : function() {
            var objSearchKeyLike = combo.getObject("SM8002_01_form_01", "schKeyLike");
    ...
    datagrid : {
    	header_1 : [//Field ID |  Field Name |  Width Size |  Align |  halign |  Sort |  hidden |  editor type |  checkbox |  format |  rowspan |  colspan |  frozen |  styler
            ["SUBJECT"              ,resource.getMessage("TITLE")           ,550    ,"left"    ,"center"    ,true       ,false    ,null         ,null     ,{format:"function", pid:"SM8002_01", name:"showNewIcon"}    ,0        ,0],
        ...
        initGrid_1 : function() {
            var params = form.handle.getElementsParam("SM8002_01_form_01");
            var dg_1 = grid.getObject("SM8002_01_grid_01");
    ...
    // 이벤트 처리
    event : {
    	onDblClick_SM8002_01_grid_01 : function(rowData) {
            SM8002_01.dialog.openDialog_1('update');
        }
    },
    // 업무구현
    control : {
    ...
    dialog : {
    	openDialog_1 : function(flag) {
            ...
            params.COMPANY_CD = form.handle.getValue("SM8002_01_form_01", "COMPANY_CD");
            params.USER_ID = form.handle.getValue("SM8002_01_form_01", "USER_ID");
            params.USER_NAME = form.handle.getValue("SM8002_01_form_01", "USER_NAME");
            params.BOARD_TYPE = form.handle.getValue("SM8002_01_form_01", "BOARD_TYPE");
            params.flag = flag;
            
            var dl_1= dialog.getObject("SM8002_02_dialog_01");
            
            dialog.init.setTitle(resource.getMessage("SM8002_02"));
            dialog.init.setWidth(800); 
            dialog.init.setHeight(552);
            dialog.init.setURL("/fm/sm/sm8002_02");
